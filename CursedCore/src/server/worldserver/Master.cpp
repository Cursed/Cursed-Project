 ...
 *
 * Copyright (C) 2008-2011 CactusEmu <http://www.cactusemu.com>
 *
...
int Master::Run()
{
    ...
    sLog.outString( " ");
	sLog.outString( " Thank you for Choosing Cursed =P ");
    sLog.outString( "  ");
	sLog.outString( "  ______  __    __  .______          _______. _______  _______");
    sLog.outString( " /      ||  |  |  | |   _  \        /       ||   ____||       \");
    sLog.outString( "|  ,----'|  |  |  | |  |_)  |      |   (----`|  |__   |  .--.  |");
    sLog.outString( "|  |     |  |  |  | |      /        \   \    |   __|  |  |  |  |");
    sLog.outString( "|  `----.|  `--'  | |  |\  \----.----)   |   |  |____ |  '--'  |");
    sLog.outString( " \______| \______/  | _| `._____|_______/    |_______||_______/ ");
    sLog.outString( "Cursed-Project 'First' Custom CactusEmu Cataclysm Communtiy Release");
    sLog.outString( "               == http://cursed-project.ceniun.co.uk ==                   ");
    sLog.outString( "");
...
void Master::clearOnlineAccounts()
{
    ...
    // Battleground instances reset at server restart
